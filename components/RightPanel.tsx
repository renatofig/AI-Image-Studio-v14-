        ...
        {hasResult && !isLoading && (
          <div className="flex flex-col w-full h-full">
              <div id="imageContainer" ref={imageContainerRef} className="image-container flex-grow w-full h-full group relative flex items-start justify-center overflow-hidden">
                ...
                {/* --- Actions Area --- */}
                <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-10">
                    {/* Left side actions */}
